...
def manage_students():
   ...
   _, first_student, last_student = students
...
def hometown_info():
    ...
    home_town_message = f"I was born in {home_town['city']}, {home_town['state']} - {home_town['population']}"
...
def filter_foods_with_a():
     foods = ('rice', 'bread', 'cookies')
     result = [food for food in foods if 'a'in food]
     return result
